...
public class Expenditure extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Meal Expense");

        jLabel4.setText("Other Expense");
        ...
        jLabel5.setText("(choose from box)");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      float mealExp=Float.valueOf(jTextField2.getText());
      float otherExp=Float.valueOf(jTextField3.getText());
      boolean bl=false;
      Jdbc ex=new Jdbc();
      ex.connection();
      if(bl==false)
      {
      ex.createTable("create table expenditure(id int auto_increment,date varchar(20),name varchar(20),"
              + "mealExp float(10,2) NOT NULL DEFAULT  " +0+ " ,otherExp float(10,2) NOT NULL DEFAULT "+0+", "
              + "PRIMARY KEY(id) )");
      bl=true;
      }
      ex.createTable("insert into expenditure (date,name,mealExp,otherExp) values('"+date+"' ,'" +name +"' ,"
              + " "+ mealExp+", "+otherExp+" )");
      ex.connectionclose();
